...
public class AttackActivity extends Activity implements SerialManager.DataListener {
    ...
    private Button btnDeauth, btnEvilTwin, btnHandshake, btnKarma, btnFull, btnTDeauth, btnStop, btnBack, btnSend, btnDebug, btnAutoScroll, btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTDeauth        = (Button) findViewById(R.id.btnTDeauth);
            ...
            btnBack   = (Button) findViewById(R.id.btnDownloadCreds);

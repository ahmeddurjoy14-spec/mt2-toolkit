...
// --- Attack Settings ---
#define DEFAULT_PKT_RATE  50    // frames per burst
#define BURST_SIZE        100   // frames per type (deauth/disassoc) - INCREASED!
#define BURST_PAUSE_MS    0     // NO delay - continuous streaming!
